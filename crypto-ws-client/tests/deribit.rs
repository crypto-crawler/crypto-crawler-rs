...
mod deribit_inverse_future {
    ...
    fn subscribe_trade() {
        gen_test_code!(
            DeribitWSClient,
            subscribe_trade,
            &vec!["BTC-30APR21".to_string(), "BTC-25JUN21".to_string()]
        );
    }
    ...
    fn subscribe_candlestick() {
        gen_test_subscribe_candlestick!(DeribitWSClient, &vec!["BTC-30APR21".to_string()], 60);
        gen_test_subscribe_candlestick!(DeribitWSClient, &vec!["BTC-30APR21".to_string()], 86400);
    }
}
...
mod deribit_option {
    ...
    fn subscribe_ticker() {
        gen_test_code!(
            DeribitWSClient,
            subscribe_ticker,
            &vec!["BTC-30APR21-64000-C".to_string()]
        );
    }
