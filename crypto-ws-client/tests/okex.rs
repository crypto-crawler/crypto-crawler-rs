...
mod okex_future {
    ...
    fn subscribe() {
        gen_test_code!(
            OkexWSClient,
            subscribe,
            &vec!["futures/trade:BTC-USDT-210924".to_string()]
        );
    }
    ...
    #[test]
    fn subscribe_candlestick() {
        gen_test_subscribe_candlestick!(OkexWSClient, &vec!["BTC-USDT-210924".to_string()], 60);
        gen_test_subscribe_candlestick!(OkexWSClient, &vec!["BTC-USDT-210924".to_string()], 604800);
    }
}
...
mod okex_option {
    ...
    fn subscribe_trade() {
        gen_test_code!(
            OkexWSClient,
            subscribe_trade,
            &vec!["BTC-USD-210924-18000-P".to_string()]
        );
    }
