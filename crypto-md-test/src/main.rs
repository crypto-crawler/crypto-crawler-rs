...
use crypto_msg_parser::{parse_l2_topk, Order, OrderBookMsg, TradeMsg, TradeSide, parse_trade};
...
async fn main() {
    ...
    let symbols_vec = &vec!["BTC-USDT".to_string()];
    ...
    // crawl_bbo("okx", MarketType::Spot, None, tx).await;
